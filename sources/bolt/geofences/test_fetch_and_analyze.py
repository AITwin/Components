...
def test_main_success():
    ...
    mock_response.json.return_value = {
        "features": [
            {
                "type": "Feature",
                "geometry": {"type": "MultiPolygon", "coordinates": [[[[4.35, 50.85], [4.36, 50.85], [4.36, 50.86], [4.35, 50.86], [4.35, 50.85]]]]},
                "properties": {
                    "name": "Test Zone",
                    "rules": [{"ride_allowed": True, "ride_through_allowed": True, "maximum_speed_kph": 6, "vehicle_type_id": ["scooter"]}]
                }
            }
        ],
